...
public class JdbcIntermediateCursorTest extends BaseIntermediateInMemoryDBCase {
  ...
  public void query_number_basic() {
    ...
    JdbcIntermediateSeance seance = session.openSeance(query, null);
    seance.execute();
    JdbcIntermediateCursor<Number[]> cursor =
  ...
  public void query_floats() {
    ...
    JdbcIntermediateSeance seance = session.openSeance(query, null);
    seance.execute();
    JdbcIntermediateCursor<Object[]> cursor =
  ...
  public void query_decimals() {
    ...
    JdbcIntermediateSeance seance = session.openSeance(query, null);
    seance.execute();
    JdbcIntermediateCursor<BigDecimal[]> cursor =
  ...
  public void query_hash_map() {
    ...
    JdbcIntermediateSeance seance = session.openSeance("select * from map_1", null);
    seance.execute();
    JdbcIntermediateCursor<Map<Integer, Long>> cursor =
  ...
  private void performStatement(final JdbcIntermediateSession session, final String statementText) {
    JdbcIntermediateSeance seance =
  ...
  private void performStatements(final JdbcIntermediateSession session, final String... statementTexts) {
  ...
  @NotNull
  private JdbcIntermediateSeance query(final String queryText) {
    JdbcIntermediateSession session = openSession();
    JdbcIntermediateSeance seance = session.openSeance(queryText, null);
    seance.execute();
    return seance;
  }
