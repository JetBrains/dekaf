...
public class MicrosoftServiceFactory implements DBServiceFactory {
  ...
  @Override
  public Rdbms rdbms() {
    return org.jetbrains.jdba.rdbms.microsoft.MicrosoftSQL.RDBMS;
  }
  ...
  public MssqlFacade createFacade(@NotNull DataSource source) {
    return new MssqlFacade(org.jetbrains.jdba.rdbms.microsoft.MicrosoftSQL.RDBMS, source, myErrorRecognizer, cloneSQL());
  }
